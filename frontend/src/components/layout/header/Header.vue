<template>
  <nav class="relative bg-gray-800">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        ...
        >
          <div class="flex shrink-0 items-center">
            <img
              src="../../../assets/logo.jpg"
              alt="logo"
              class="size-8 rounded-full object-cove"
            />
          </div>
        ...
        >
          <button
            type="button"
            class="relative rounded-full p-1 text-gray-400 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500"
          >
          ...
          <el-dropdown class="relative ml-3">
            ...
            >
              <a
                href="#"
                class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-none"
                >Your profile</a
              >
              <a
                href="#"
    ...
    <el-disclosure
      id="mobile-menu"
      hidden
      class="sm:hidden [&:not([hidden])]:block"
    >
